...
SECRET_KEY = 'r4st3_4cyw3xgvw0pwz)-74*r0c7k8n)#e#4jp813ync4lmzpd'
...
EMAIL_PORT = 25
#发送邮件的邮箱
EMAIL_HOST_USER = '18846121015@163.com'
#在邮箱中设置的客户端授权密码
...
CRONJOBS = [
    # 每5分钟执行一次生成主页静态文件
    ('*/1 * * * *', 'contents.crons.generate_static_index_html', '>> /home/python/mall/malls/logs/crontab.log')
]
